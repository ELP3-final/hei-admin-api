...
------------ | ------------- | ------------- | -------------
*AttendingApi* | [**getEvents**](docs/AttendingApi.md#getEvents) | **GET** /events | Get all events
*AttendingApi* | [**getEventsWithHttpInfo**](docs/AttendingApi.md#getEventsWithHttpInfo) | **GET** /events | Get all events
*AttendingApi* | [**getEventsById**](docs/AttendingApi.md#getEventsById) | **GET** /events/{id} | get events by id
*AttendingApi* | [**getEventsByIdWithHttpInfo**](docs/AttendingApi.md#getEventsByIdWithHttpInfo) | **GET** /events/{id} | get events by id
*AttendingApi* | [**getPlaceById**](docs/AttendingApi.md#getPlaceById) | **GET** /places/{id} | get place by id
*AttendingApi* | [**getPlaceByIdWithHttpInfo**](docs/AttendingApi.md#getPlaceByIdWithHttpInfo) | **GET** /places/{id} | get place by id
*AttendingApi* | [**getPlaces**](docs/AttendingApi.md#getPlaces) | **GET** /places | get all places
*AttendingApi* | [**getPlacesWithHttpInfo**](docs/AttendingApi.md#getPlacesWithHttpInfo) | **GET** /places | get all places
*AttendingApi* | [**putEvents**](docs/AttendingApi.md#putEvents) | **PUT** /events | create or update events
*AttendingApi* | [**putEventsWithHttpInfo**](docs/AttendingApi.md#putEventsWithHttpInfo) | **PUT** /events | create or update events
*AttendingApi* | [**saveOrUpdatePlaces**](docs/AttendingApi.md#saveOrUpdatePlaces) | **PUT** /places | save or update existing places
*AttendingApi* | [**saveOrUpdatePlacesWithHttpInfo**](docs/AttendingApi.md#saveOrUpdatePlacesWithHttpInfo) | **PUT** /places | save or update existing places
...
*PlacesApi* | [**createOrUpdateEventParticipants**](docs/PlacesApi.md#createOrUpdateEventParticipants) | **PUT** /events/{event_id}/event_participants | Create or update event participants
